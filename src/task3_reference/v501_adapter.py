...
class Task3V501Adapter:
    ...
    def initialize(self, session_info=None):
        ...
        model_path=Path(t.get('detector_model_path') or cfg.detector.get('model_path','models/yolov8n.pt')); model_path=model_path if model_path.is_absolute() else Path.cwd()/model_path
